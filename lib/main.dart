...
import 'package:nikitaabsen/settings.dart';
...
void main() async {
  ...
  runApp(MyHomeAttPage(initialScreen: initialScreen));
}



// ignore: must_be_immutable
class MyHomeAttPage extends StatefulWidget {
  final String title ="";
  var personList = <Person>[];
  final Widget initialScreen;

  MyHomeAttPage({super.key, required this.initialScreen});

  @override
  MyHomeAttPageState createState() => MyHomeAttPageState();
}

class MyHomeAttPageState extends State<MyHomeAttPage> {
