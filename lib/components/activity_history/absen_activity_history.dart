...
class AbsenActivityHistory extends StatelessWidget {
  const AbsenActivityHistory({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    _activity.pagingController.addPageRequestListener((pageKey) {
      _activity.setAbsenCheckoutActivity(pageKey);
    });

    return RefreshIndicator(
       onRefresh: () async {
        _activity.setAbsenCheckoutActivity(0);
      },
